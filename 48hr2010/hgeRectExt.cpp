...
void hgeRectExt::Render()
{
	...
	hge->Gfx_RenderLine(x1, y1, x2, y1, 0xFFFF0000, 0);
	hge->Gfx_RenderLine(x2, y1, x2, y2, 0xFFFF0000, 0);
	hge->Gfx_RenderLine(x2, y2, x1, y2, 0xFFFF0000, 0);
	hge->Gfx_RenderLine(x1, y2, x1, y1, 0xFFFF0000, 0);
